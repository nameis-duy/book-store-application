...
public class Constants {
    ...
    //PAYMENT MESSAGE
    public static final String PAYMENT_MESSAGE = "Payment Message";
    ...
    public static final String NOTIFICATION_AFTER_LOGIN = "You have %d items in your shopping cart awaiting payment. Please proceed with the payment to complete the process and enjoy the best experience.";
    ...
    public static final String CHECKOUT_ERROR = "Payment failed. Please Try again.";
